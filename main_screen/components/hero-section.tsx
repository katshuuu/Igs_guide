  ...
  return (
    ...
    >
      ...
      {/* ═══════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════ */}
      {/* 
        НАСТРОЙКИ ПОЗИЦИЙ ПУЗЫРЕЙ:
        - top/left/right: проценты от края экрана
        - Ближе к центру = увеличить left/уменьшить right
        - Ниже = увеличить top
      */}
      <div className="hidden md:block z-10">
        {/* "можно ли застраховать новый телефон" - Top left */}
        <div className="absolute top-[10%] left-[18%]">
          <SearchBubble text="можно ли застраховать новый телефон" size="large" />
        </div>

        {/* "как застраховать новый велосипед" - Right side, верхняя часть */}
        <div className="absolute top-[26%] right-[15%]">
          <SearchBubble text="застраховать дорогой велосипед недорого" size="large" />
        </div>

        {/* "страховой случай это" - Left side, середина */}
        <div className="absolute top-[48%] left-[22%]">
          <SearchBubble text="страховой случай это" size="large" />
        </div>

        {/* "где застраховать питомца котенка" - Right side, четвертая четверть (внизу справа) */}
        <div className="absolute top-[64%] right-[8%]">
          <SearchBubble text="где застраховать питомца котенка" size="large" />
        </div>
      </div>
      ...
      <div className="md:hidden absolute bottom-8 left-0 right-0 flex flex-col items-center gap-3 px-4 z-10">
        <SearchBubble text="можно ли застраховать новый телефон" />
        <SearchBubble text="как застраховать новый велосипед" />
        <SearchBubble text="страховой случай это" />
        <SearchBubble text="где застраховать питомца котенка" />
      </div>
