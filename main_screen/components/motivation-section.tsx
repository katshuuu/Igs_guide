...
export function MotivationSection({ onStartGuide }: MotivationSectionProps) {
  ...
  const keyMotivation =
    "Чтобы ты увидел, сколько риск реально может стоить — до того, что-то случится в настоящей жизни.";
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        {/* Main heading */}
        <motion.h2
          className="flex flex-wrap justify-center text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-12 text-center"
        ...
        >
          ...
          >
            ...
            />
            <span className="relative z-10"> Пройти игру </span>
          </motion.button>
        </motion.div>
      </div>
